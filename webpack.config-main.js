...
const preloadConfig = getConfig({
  ...
  entry: {
    'view-preload': './src/wexond/preloads/view-preload',
  },
...
if (process.env.ENABLE_EXTENSIONS) {
  preloadConfig.entry['popup-preload'] = './src/wexond/preloads/popup-preload';
  preloadConfig.entry['extensions-preload'] =
    './src/wexond/preloads/extensions-preload';
}
